...
|----|------------|-------------|
| **M1036** | **Account Use Policies** | Set account lockout policies after a certain number of failed login attempts to prevent password guessing. Use conditional access to block non-compliant devices or external IPs. Consider blocking risky authentication originations (e.g., proxies/anonymizers). |
